...
namespace SistemaGestionOperacionesView {
	...
	/// <summary>
	/// Resumen de frmNuevoRecurso
	/// </summary>
	public ref class frmNuevoRecurso : public System::Windows::Forms::Form
	{
	public:
		frmNuevoRecurso(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnGrabar->Click += gcnew System::EventHandler(this, &frmNuevoRecurso::btnGrabar_Click);
			// 
			// btnCancelar
			// 
			...
			this->btnCancelar->Click += gcnew System::EventHandler(this, &frmNuevoRecurso::btnCancelar_Click);
			// 
			// frmNuevoRecurso
			// 
			...
			this->Name = L"frmNuevoRecurso";
			this->Text = L"Crear un nuevo Recurso";
...
#pragma endregion
	...
	private: System::Void btnGrabar_Click(System::Object^ sender, System::EventArgs^ e) {
		 // Aquí puedes agregar la lógica para grabar el nuevo recurso
		 int idRecurso = Convert::ToInt32(txtIdRecurso->Text);
		 String^ nombre = txtNombre->Text;
		 int cantidad = Convert::ToInt32(txtCantidad->Text);
		 String^ estado = cmbEstado->Text;
		 // Validar los campos antes de guardar
		 if (idRecurso == 0 || nombre->Equals("") || cantidad == 0 || estado->Equals("")) {
			 MessageBox::Show("Por favor, complete todos los campos.", "Error", MessageBoxButtons::OK, MessageBoxIcon::Error);
			 return;
		 }
		 // Lógica para guardar el nuevo recurso
		 RecursoController^ recursoController = gcnew RecursoController();
		 recursoController->agregarRecurso(idRecurso, nombre, cantidad, estado);
